...
class LongConvModel(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.preprocessing = Preprocessing(normalize, remove_baseline, remove_hf_noise, should_pre_transpose=True)
...
if __name__ == '__main__':
    model = LongConvModel(12, True, True, True, 256)
    example = torch.rand(2, 4096, 12)
